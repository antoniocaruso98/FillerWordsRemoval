...
def split_audio_librosa(file_path, clip_length=10, output_folder="clips"):
    ...
    try:
        ...
        for i in range(num_clips):
            ...
            # Output file name
            output_path = os.path.join(output_folder, f"{nome_file}_clip_{i + 1}.wav")
...
if __name__ == "__main__":
    ...
    for nome_file in os.listdir('./train-clean-100-flat'):
        split_audio_librosa(os.path.join('train-clean-100-flat',nome_file), clip_length=1)
